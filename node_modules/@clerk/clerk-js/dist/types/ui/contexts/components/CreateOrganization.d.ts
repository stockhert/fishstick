...
export declare const useCreateOrganizationContext: () => {
    ...
    afterCreateOrganizationUrl?: ((organization: OrganizationResource) => string) | ((string & Record<never, never>) | ":name" | ":slug" | ":id" | ":imageUrl" | ":hasImage" | ":pathRoot" | ":membersCount" | ":pendingInvitationsCount" | ":adminDeleteEnabled" | ":maxAllowedMemberships");
