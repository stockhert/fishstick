...
export declare const useOrganizationListContext: () => {
    ...
    afterSelectOrganizationUrl?: ((organization: OrganizationResource) => string) | ((string & Record<never, never>) | ":name" | ":slug" | ":id" | ":imageUrl" | ":hasImage" | ":pathRoot" | ":membersCount" | ":pendingInvitationsCount" | ":adminDeleteEnabled" | ":maxAllowedMemberships");
